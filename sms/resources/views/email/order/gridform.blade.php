...
<html>
	...
	<body style="margin:30px auto; width:850px;font-family: 'Montserrat', sans-serif;">
		...
		<div style="align:center; border:1px solid #ccc; padding-top:30px; padding-bottom:40px">
			<h2 style="margin-bottom: 35px;font-size: 25px;color:#000; font-size: 20px; text-align: center;">Grid Forms  {{ $customer->street_number }} {{  $customer->street_name }} {{  $customer->suburb }} {{ $customer->state  }} {{ $customer->post_code }} , {{ $customer->phone_mobile }} </h2>
					...
					<td colspan="6" class="item_tbl" style="text-align: center;padding: 25px 0px !important;background: #ededed;padding: 10px 20px;font-size: 15px;padding: 0;">
						<table class="tbl_order" style="background-color: #EDEDED;color: #000;border-bottom: 1px dashed #d3d3d3;">
							<div class="wrap_table" style="text-align: left;width: 80%;margin: 0 auto;">
								<h4 style="color: #333333; margin-left: 23px;margin: 10px 0px 20px;"><b>Hello </b></h4h4>
								<p style="margin:0px; text-align:center; font-size:15px;line-height: 23px;text-align: left;">
                                    Please find attached Grid paperwork for {{ $customer->first_name }} {{ $customer->last_name }} </p>
                                </br>
                                <p style="margin:0px; text-align:center; font-size:15px;line-height: 23px;text-align: left;">
                                        {{ $customer->nmi }}</p>
                                    </br>
                                <p style="margin:0px; text-align:center; font-size:15px;line-height: 23px;text-align: left;">
                                        If you require any paperwork amended, can you please let me know ASAP so we do not delay your customer. </p>
                                        </br>
                                <p style="margin:0px; text-align:center; font-size:15px;line-height: 23px;text-align: left;">
                                        {{ $customer->first_name }}, if you haven't heard from {{ $provider->name }} within 5 business days please give them a call to see where they are at with your forms.
                                </p>
                                </br>
