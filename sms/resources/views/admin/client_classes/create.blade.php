...
@section('title','Create Fee Schedules')
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Create Client Class</h3>
            ...
            {!! Form::open(['url' => '/admin/client_classes', 'class' => 'form-horizontal','id' => 'module_form','autocomplete'=>'off']) !!}

            @include ('admin.client_classes.form')
