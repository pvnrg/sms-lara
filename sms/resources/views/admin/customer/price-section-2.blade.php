<table style="background:#d8d8d8;width:850px;margin:0 0 0 0;padding:10px 50px 0px 50px;">
		...
		<tr>
		   <td style="padding:0 0 0 50px;">
				<table style="padding:0px;border-spacing:0px!important;margin:0 0 0 120px;height:300px;">				
					<tr>
				...
				<table style="padding:0px;border-spacing:0px!important;margin:0 0 0 120px; height:800px;">
					<tr>
                        @foreach($offer->offer_detail as  $indexKey=>$offers )
				...
				<table style="padding:0px;border-spacing:0px!important;margin:0 0 0 120px;">
					<tr>
                        @foreach($offer->offer_detail as  $indexKey=>$offers )
							@php 
								$package_obj = json_decode($offers->package_obj); 
