    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Create Fee Schedules</h3>
            ...
            {!! Form::open(['url' => '/admin/fee_schedules', 'class' => 'form-horizontal','id' => 'module_form','autocomplete'=>'off']) !!}

            @include ('admin.fee_schedules.form')
