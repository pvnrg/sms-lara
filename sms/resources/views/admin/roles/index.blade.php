            ...
            <div class="box">
                <div class="box-header">
                    ...
                    @if(Auth::user()->can('access.role.create'))
                        <a href="{{ url('/admin/roles/create') }}" class="btn btn-success btn-sm pull-right"
                            title="Add New Role">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            @if(Auth::user()->can('access.role.delete'))
                                                <form method="POST" action="{{ url('/admin/roles'.'/'.$item->id) }}" accept-charset="UTF-8" style="display:inline" class = "confirm_delete">
                                                    {{ method_field('DELETE') }}
                                                    {{ csrf_field() }}
